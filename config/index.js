...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxe3581a2c9eed8f3d',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'a8ef24ea912cc48ffe3d660f3bbd52b4',
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'JI7rwJRGtyppVSOPdL1T5Vn5EXnEe6Jrwdu4xtCtcKQ',
      // 所在省份
      province: '安徽',
      // 所在城市
      city: '淮南',
      ...
      festivals: [
        ...
        {
          type: '1', name: '1', year: '1999', date: '09-29',
        },
        {
          type: '1', name: '1', year: '2021', date: '09-01',
        }
      ],
      ...
      customizedDateList: [
        ...
        // 退伍日
        { keyword: 'ex_day', date: '2023-04-22' }
      ],
      // 课程表相关配置
